...
public class BtnMyBigture extends RelativeLayout {
	Context context;
	TextView title;
	
	public BtnMyBigture(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onFinishInflate() {
		...
		this.title.setText(getResources().getString(R.string.common_lb_menu_mybigture));
	}
