...
public class ShaderStroke extends NormalStroke{
	Context context;
	String assetId;

	public ShaderStroke(Context context)
	{
		super();
	...
	public ShaderStroke(Context context, String assetId, int color, float thick)
	{
		this(context);
	...
	public String toXML()
	{
		...
		sb.append("<ShaderStroke color=\"" + color + "\" assetId=\"" + assetId + "\" thick=\"" + thick + "\">");
